      ...
      <section>
        <div className="bg-[#d9e6dc]">
          <div className="container mx-auto px-5 pb-12">
            <div className="grid lg:grid-cols-4 sm:grid-cols-2 xl:gap-20 lg:gap-12 gap-5 *:border *:bg-[var(--lgreen3)] *:p-4 *:pb-10 *:rounded-2xl *:text-center *:text-[27px] *:font-semibold *:text-[var(--dgreen)] *:relative [&_i]:absolute [&_i]:-right-[65px] [&_i]:top-[40%]  [&_i]:text-5xl [&_i]:md:block [&_i]:hidden [&>i]:-translate-y-1/2">
              <div>
