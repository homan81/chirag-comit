    ...
    <section className="min-h-screen py-5">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-wrap">
          ...
          <div className="w-full md:w-1/2 md:p-8 py-8 md:sticky md:top-[50px] md:h-screen">
            <div className="max-w-xl mb-3">
              <h2
                ref={ref}
                className={`fade-up ${
              ...
              >
                ...
                Organisation Strategy & On-ground Execution. Our approach blends
                data-backed analytics with field-tested pragmatism, ensuring
                every recommendation can be executed and sustained on ground.
              </p>
            </div>
          </div>
          ...
          <div
            className="w-full md:w-1/2 md:p-8 py-8 space-y-6 right-sticky-process text-white 
                      [&>*:nth-child(odd)]:bg-[var(--dgreen)] 
                      [&>*:nth-child(even)]:bg-[var(--dgreen2)] 
                      *:rounded-lg *:p-8 *:lg:px-18 *:mb-0"
          >
            <div ref={ref} className={`fade-up ${isVisible ? "show" : ""}`}>
              <h3 className="text-[60px] md:text-[80px] lg:text-[100px] font-light">
                1
              </h3>
              <h4 className="font-medium leading-[120%] text-3xl mb-6">
                GTM TRANSFORMATION
              </h4>
              <p className="text-[18px] lg:text-[20px]">
                We redefine go-to-market strategy to deliver profitable,
                scalable growth through sharper market design and execution
                excellence.
              </p>
            </div>
