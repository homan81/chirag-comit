            ...
            <div className="flex justify-center items-stretch flex-wrap mb-5 2xl:gap-12 lg:gap-8 gap-3 *:md:w-[48%]  *:w-full *:md:max-w-full *:max-w-[400px] [&>div>div]:py-3 [&>div>div]:lg:px-10 [&>div>div]:px-5 [&>div>div]:text-center [&>div>div]:text-white [&>div>div]:text-xl [&>div>div]:rounded-md [&>div>div]:flex [&>div>div]:items-center [&>div>div]:justify-center [&>div>div]:h-full  [&>div>div]:transition [&>div>div]:ease-in-out [&>div>div]:hover:opacity-90">
              ...
              >
                <div className="bg-[var(--dgreen)] ">
                  Revenue grew from $30 Mn to $63 Mn over four years, with gross
                  margins improving from -7% to +27%.
                </div>
              </div>
              <div
                ref={link2.ref}
              ...
              >
                <div className="bg-[var(--dgreen2)] ">
                  Premium portfolio mix increased from 20% to 70%, driving
              ...
              >
                <div className=" bg-[var(--dgreen2)]">
                  Distribution coverage expanded 4×, supported by digitized
              ...
              >
                <div className="bg-[var(--dgreen)] ">
                  Distributor monthly throughput improved 5×, reflecting sharper
                  focus and improved portfolio productivity.
                </div>
              </div>
              ...
              >
                <div className="bg-[var(--dgreen)] ">
                  The business successfully transitioned from a volume-led,
                  push-sell model to a value-driven, profitable enterprise with
