              ...
              <div className="max-w-[1100px] mx-auto">
                <div className="flex md:flex-row flex-col md:gap-0 gap-5 justify-between w-full text-center px-5 *:max-w-[300px] *:mx-auto [&_p]:text-[var(--dgreen)] [&_h3]:text-[var(--dgreen)] [&_h3]:font-semibold [&_img]:max-w-[90px] [&_img]:mb-3 [&_img]:h-auto [&_img]:mx-auto">
                  <div>
                    ...
                    <p className="text-xl">Mid Sized MNC</p>
                  </div>
                  <div>
                     <Image
                    ...
                    <p className="text-xl">FMCG Foods</p>
                  </div>
                  <div>
                     <Image
                ...
                <p className="md:px-9 p-3  bg-[var(--dgreen2)] text-white text-center text-[16px] font-medium mt-7 rounded-md">The company wanted to ensure the category sold to the right store as it needed a cold chain environment and also make the product available in weighted stores.</p>
