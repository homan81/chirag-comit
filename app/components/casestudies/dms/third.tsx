          ...
          <div className="container mx-auto px-5 pb-10">
            <div className=" border border-[#AEAEAE] bg-white rounded-lg lg:py-8 lg:px-20 p-5 -mt-[100px] shadow-[0_0_13px_#00000052]">
              <div className="max-w-[1100px] mx-auto">
                ...
                <p className="px-9 py-3 bg-[var(--dgreen2)] text-white text-center text-[16px] font-bold mt-7 rounded-md">The company wanted to gain access to its secondary sales and inventory which was manual and also to streamline the distributor claim process.</p>
